...
<head>
    <meta charset="UTF-8">
    <title>Sweet Desert♡ |Add/Delete Crepe</title>
...
<div align="left">
    <input id="btn" style="cursor: pointer;padding-top: 10px;padding-bottom:10px;display: inline-block;width: 200px; font-weight: bold; font-size: 20px; color: black; margin-left: 40%; background-color:#ff6d84;border-color: black;border-radius: 50px" type="submit" value="Add Crepe" name="submit" ;">
</div>
<div align="left" >
    <input id="dd" style="cursor: pointer;padding-top: 10px;padding-bottom:10px;display: inline-block;width: 200px; font-weight: bold; font-size: 20px; color: black; margin-left: 40%; background-color:#ff6d84;border-color: black;border-radius: 50px" type="submit" value="Delete Crepe" name="submit" ;">
</div>
</form>
