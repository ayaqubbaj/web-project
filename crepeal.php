...
<head>
    <meta charset="UTF-8">
    <title>Sweet Desert♡ | Crepe</title>
    ...
    <div class="bar"><ul>
            ...
            <li><a class="active" href="#">Menu</a>
                <ul>
                    ...
                    <li><a class="active" href="#">Crepes</a></li>
                </ul>
            </li></ul>
    </div>
    <div class="nbar">
        ...
        if(!$conn){
            ...
            if(mysqli_num_rows($result) < 1){
                ...
                while($row = mysqli_fetch_array($result)){
                    ...
                    $price=$row['price'];
                    $i++;
                    echo"<div id='sweet' class='box'>
                <form action='crepeal.php#sweet' method='post'>
