...
<head>
    <meta charset="UTF-8">
    <title>Sweet Desert♡ | Waffles</title>
...
<section class="features" id="features">
    <div class="box-container">
        <!--single item-->
            ...
            if(!$conn){
                ...
                if(mysqli_num_rows($result) < 1){
                    ...
                    while($row = mysqli_fetch_array($result)){
                        ...
                        echo"<div class='box'>
            <img name='image' src='imgs/".$row['image']."' alt=''>
            <h3>".$row['name']."  </h3>
            ...
            <button onclick='warnn()' type='submit' value='addtoCart' class='buttonbuy' name='add-to-cart' href='#'
